  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <?php if ($_SESSION['rol'] == 1) { ?>
        <a class="nav-item nav-link" href="addplz.php"><i class="fas fa-project-diagram"></i> Modulos</a>
        <a class="nav-item nav-link" href="usrs.php"><i class="fas fa-user-plus"></i> Usuarios </a>
        <a class="nav-item nav-link" href="historial.php"><i class="fas fa-history"></i> Historial</a>
      <?php } ?>
...
-->
    ...
    <form class="form-inline my-2 my-lg-0">
      <a class="nav-item nav-link" href="logout.php" style="color: #616161;"> Salir <i class="fas fa-sign-out-alt"></i></a>
    </form>
