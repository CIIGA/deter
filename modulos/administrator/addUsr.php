        ...
        where correo='$correo'";
            ...
            Swal.fire({
              ...
              if (result.dismiss === Swal.DismissReason.timer) {
                ...
                echo '<meta http-equiv="refresh" content="2,url=addUsr.php">';
            } else {

                $newUsr = "insert into usuarioNuevo (id_rol,nombreUsr,correo,clave,insertDate,estado) values ($idRol,'$nombre','$correo','$clave','$lastAccess',$estado)";
                sqlsrv_query($cnx, $newUsr) or die('No se ejecuto la consulta isert nuevo usr');
        ...
        <div class="container">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Nuevo Usuario Implementta DCF</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form action="" method="post">
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombre" class="form-control form-control-sm" minlength="5" maxlength="40" placeholder="Nombre de Usuario" autofocus required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Correo: *</label>
                                    <input type="email" name="correo" class="form-control form-control-sm" autocomplete="new-password" minlength="5" maxlength="300" placeholder="correo@erdm.mx" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="password" name="clave" class="form-control form-control-sm" autocomplete="new-password" minlength="6" maxlength="20" placeholder="Contraseña (min. 6 caracteres)" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                    ...
                    <div class="card-footer">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-3">
                                <button type="submit" class="btn btn-primary btn-sm btn-block" name="save"><i class="fas fa-check"></i> Guardar</button>
                            </div>
                        </div>
                    </div>
                </form>
